...
import '../../on_boarding/started_view/started_screen.dart'
...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _handleNoAccountTap() async {
    ...
    final hasCompleteOnboarding = await _loginController
        .hasCompleteGuestOnboarding();
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: Text(
                        ...
                        style: AppStyles.heading1.copyWith(
                          fontSize: responsive.fontSize(
                            AppStyles.heading1.fontSize ?? 32,
                          ),
                  ...
                  FadeTransition(
                    ...
                    child: SlideTransition(
                      position: _slideAnimation,
                      child: NoAccountButton(onPressed: _handleNoAccountTap),
                    ),
                  ),
                  responsive.verticalSpace(24),
                ],
