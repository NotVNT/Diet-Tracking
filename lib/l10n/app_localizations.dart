...
abstract class AppLocalizations {
  ...
  /// No description provided for @approxWeeks.
  ///
  /// In en, this message translates to:
  /// **'≈ {weeks} weeks'**
  ...
  /// No description provided for @unhealthyDietWarning.
  ///
  /// In en, this message translates to:
  /// **'This diet plan may not be suitable for your health.'**
  String get unhealthyDietWarning;
  ...
  /// No description provided for @missingUserInfo.
  ///
  /// In en, this message translates to:
  /// **'Missing user information. Please go back and fill in all details.'**
  String get missingUserInfo;
  ...
  /// No description provided for @recommendationFormat.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @understandRisks.
  ///
  /// In en, this message translates to:
  /// **'I understand the risks'**
  String get understandRisks;

  /// No description provided for @planSavedMessage.
  ///
  /// In en, this message translates to:
  /// **'Plan saved. Please consult an expert.'**
  String get planSavedMessage;
}
