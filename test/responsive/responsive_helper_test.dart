...
void main() {
  Future<void> withSize(WidgetTester tester, Size size, void Function(BuildContext) body) async {
  ...
  group('ResponsiveHelper deviceType', () {
    testWidgets('classifies by width thresholds', (tester) async {
      ...
      await withSize(tester, const Size(500, 900), (ctx) {
      ...
      await withSize(tester, const Size(1000, 1200), (ctx) {
